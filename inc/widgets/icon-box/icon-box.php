			...
			$list_field = array(
				...
				'icon_type'       => array(
					...
					"options"       => array(
						...
						"icomoon"       => esc_html__( "Font Icomoon Icon", 'eduma' ),
				...
				'font_7_stroke_group' => array(
					...
					'state_handler' => array(
						...
						'icon_type_op[icomoon]'       => array( 'hide' ),
				...
				'font_icomoon_group'  => array(
					'type'          => 'section',
					'label'         => esc_html__( 'Font Icomoon', 'eduma' ),
					'hide'          => true,
					'state_handler' => array(
						'icon_type_op[font-awesome]'  => array( 'hide' ),
						'icon_type_op[custom]'        => array( 'hide' ),
						'icon_type_op[font-7-stroke]' => array( 'hide' ),
						'icon_type_op[icomoon]'       => array( 'show' ),
					),
					'fields'        => array(
						'icon'      => array(
							"type"        => "icomoon",
