...
function thim_tp_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'required'           => true, // If false, the plugin is only 'recommended' instead of required
			'version'            => '1.9.3.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url'       => '', // If set, overrides default API URL and points to an external URL
		),
...
//		array(
//			'name'               => 'Thim Event Authentication', // The plugin name
//			'slug'               => 'tp-event-auth', // The plugin slug (typically the folder name)
//			'source'             => THIM_DIR . 'inc/plugins/tp-event-auth.zip', // The plugin source
//			'required'           => false, // If false, the plugin is only 'recommended' instead of required
...
//		),
		...
		array(
			'name'               => 'LearnPress Colections', // The plugin name
			'slug'               => 'learnpress-collections', // The plugin slug (typically the folder name)
			'source'             => THIM_DIR . 'inc/plugins/learnpress-collections.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
			'version'            => '1.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'               => 'LearnPress Certificates', // The plugin name
			'slug'               => 'learnpress-certificates', // The plugin slug (typically the folder name)
			'source'             => THIM_DIR . 'inc/plugins/learnpress-certificates.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
			'version'            => '1.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'               => 'LearnPress WooCommerce Payment Methods', // The plugin name
			'slug'               => 'learnpress-woo-payment', // The plugin slug (typically the folder name)
			'source'             => THIM_DIR . 'inc/plugins/learnpress-woo-payment.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
			'version'            => '1.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'               => 'LearnPress Stripe Payment', // The plugin name
			'slug'               => 'learnpress-stripe', // The plugin slug (typically the folder name)
			'source'             => THIM_DIR . 'inc/plugins/learnpress-stripe.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
			'version'            => '1.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
