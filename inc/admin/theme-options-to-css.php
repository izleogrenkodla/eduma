...
function thim_customcss() {
	...
	$custom_css = '';
	if ( isset( $thim_options['thim_support_icomoon'] ) && $thim_options['thim_support_icomoon'] == '1' ) {
		$icomoon_css = thim_file_get_contents( THIM_DIR . "assets/css/import-icomoon.css" );;
